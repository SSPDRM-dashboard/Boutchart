...
export { collection, doc, setDoc, getDoc, getDocs, deleteDoc, query, where, orderBy, signInWithPopup, signOut, onAuthStateChanged, signInWithEmailAndPassword, createUserWithEmailAndPassword, User };
