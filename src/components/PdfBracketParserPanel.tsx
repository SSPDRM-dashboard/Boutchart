...
export function PdfBracketParserPanel({
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      {/* Extracted Fields / Column Explanation Guide */}
      {!parsedDivisions && !isParsing && (
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-xs font-black text-slate-800 uppercase tracking-wider">
              Extracted Columns &amp; Field Descriptions
            </h4>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            <div className="p-3 bg-white border border-slate-200 rounded-xl space-y-1">
              <span className="font-bold text-slate-900 block">1. Category / Division</span>
              <p className="text-[11.5px] text-slate-500 leading-normal">
                Weight category or division title extracted from page headers. (e.g. <code>Male -60kg</code>)
              </p>
            </div>
            <div className="p-3 bg-white border border-slate-200 rounded-xl space-y-1">
              <span className="font-bold text-slate-900 block">2. Competitor Name</span>
              <p className="text-[11.5px] text-slate-500 leading-normal">
                Athlete name listed in bracket match slots or seeds, ignoring BYE slots.
              </p>
            </div>
            <div className="p-3 bg-white border border-slate-200 rounded-xl space-y-1">
              <span className="font-bold text-slate-900 block">3. Club / Dojo / Team</span>
              <p className="text-[11.5px] text-slate-500 leading-normal">
                Team or gym name printed under or alongside competitor labels.
              </p>
            </div>
            <div className="p-3 bg-white border border-slate-200 rounded-xl space-y-1">
              <span className="font-bold text-slate-900 block">4. Official Bout Numbers</span>
              <p className="text-[11.5px] text-slate-500 leading-normal">
                Pre-assigned match sequence IDs from external tournament systems (Smoothcomp, etc.).
              </p>
            </div>
          </div>
        </div>
